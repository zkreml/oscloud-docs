# <img src="/img/freshrss-logo.png" width="25px"> FreshRSS na Oscloud

**FreshRSS** je rychlá a přehledná RSS čtečka,
která vám umožní sledovat oblíbené weby,
blogy nebo novinky z jednoho místa – bez reklam a algoritmů.
Na OSCloudu je k dispozici jako jedna z předinstalovaných aplikací.
...
1. **Zaregistrujte se do OSCloudu**: [https://oscloud.cz](https://oscloud.cz) nebo požádejte o přístup na [helpdesk.oscloud.cz](https://helpdesk.oscloud.cz/help/711028727)
...
2. Vyberte možnost:
   - Ruční přidání nové RSS adresy
   - Import ze souboru `.opml` (např. z Feedly, Inoreader)
...
Pokud máte dotazy, nebo potřebujete s něčím pomoct, kontaktujte nás přes [helpdesk.oscloud.cz](https://helpdesk.oscloud.cz/help/711028727).
...
4. Otevřete **Nastavení** a zadejte přihlašovací údaje ke svému Wallabag účtu:
   - URL instance (např. `https://read.oscloud.cz`)
   - Klíč a tajný klíč aplikace (získáte v nastavení Wallabag)
...
> Wallabag je také dostupný na OSCloud na adrese: [https://read.oscloud.cz](https://read.oscloud.cz)
